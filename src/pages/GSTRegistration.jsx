...
import React from "react";
import backgroundImg from "../assets/gst-registration.jpg"; // Add your GST-related background image here
import { Link } from "react-router-dom";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-4 text-center">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold leading-tight">
          Get Your{" "}
          <span className="text-blue-300">GST Registration</span> Online – Same Day Process!
        </h1>

        {/* Subheading */}
        <p className="text-lg font-medium text-gray-100">
          Trusted by Businesses Across India for{" "}
          <span className="font-semibold">GST Services</span>
        </p>
